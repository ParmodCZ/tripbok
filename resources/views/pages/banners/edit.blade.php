    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          {{Form::text('data[Banner][title]',$banner_detail->title, $attributes =array('id'=>'banner_title', 'class'=>'form-control','required' => 'required'))}}
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          {{Form::text('data[Banner][display_order]',$banner_detail->display_order, $attributes =array('id'=>'order', 'class'=>'form-control'))}}
          <!-- isnumaric -->
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          {{Form::text('data[Banner][url]',$banner_detail->url, $attributes =array('id'=>'url', 'class'=>'form-control'))}}
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          {{Form::label('status','Price Per Min(in $):', array('class' => 'form-control-label'))}}
          {{Form::select('data[Banner][status]',$status,$banner_detail->status, $attributes =array('id'=>'status', 'class'=>'form-control'))}}
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="custom-control custom-radio custom-control-inline">
            {{Form::radio('data[Banner][validity]',1,($banner_detail->status ==1) ? true :false, array('class'=>'custom-control-input', 'id'=>'Validity1','value'=>1))}} 
            {{Form::label('Validity1', 'Permanent', array('class' => 'custom-control-label'))}}
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            {{Form::radio('data[Banner][validity]',0,($banner_detail->status ==0) ? true :false,array('class'=>'custom-control-input', 'id'=>'Validity0','value'=>0))}}
