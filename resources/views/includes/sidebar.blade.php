   ...
   <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('admin/trips/add') }}">Add Trips</a>
            <a class="collapse-item" href="{{ url('admin/trips/index') }}">All Trips</a>
   ...
   <li class="nav-item">
      ...
      <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('admin/mails/composer') }}">Compose Mail</a>
            <a class="collapse-item" href="{{ url('admin/mails/sent') }}">sent</a>
            <a class="collapse-item" href="{{ url('admin/mails/index') }}">index</a>
